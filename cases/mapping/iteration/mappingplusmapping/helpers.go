...
func Deploy(c *ctx) (*dep, error) {
	...
	addr, tx, cont, err := DeployMappingPlusMapping(c.Auth, c.Blockchain)
...
func SetupSession(gasPrice *big.Int, gasLimit uint64, c *ctx, d *dep) *MappingPlusMappingSession {
	return &MappingPlusMappingSession{
		Contract: d.Contract,
